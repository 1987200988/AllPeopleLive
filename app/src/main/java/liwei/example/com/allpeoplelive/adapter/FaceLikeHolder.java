...
public class FaceLikeHolder extends BaseViewHolder<FaceControlBean.RoomBean> {

    private final RecyclerView recyclerView;
    private final TextView textView;

    public FaceLikeHolder(View itemView) {
        super(itemView);
    ...
    /*    thumb播放前的画面 nick主播昵称 view观看数量
        avatar主播的图片    title标题 */
        RecycleCommonAdapter<FaceControlBean.RoomBean.ListBean> recycleCommonAdapter = new RecycleCommonAdapter<FaceControlBean.RoomBean.ListBean>(context, R.layout.facelikerecycleitemitem, list) {
